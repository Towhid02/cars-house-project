...
const Details = () => {
  ...
  <span className="relative px-5 py-2.5 transition-all ease-in duration-75  dark:bg-gray-900 rounded-md group-hover:bg-opacity-0"><Link to={'/addChart'}>Add Chart</Link></span></button>
  </div>
</div>
<Footer></Footer>
</div>
